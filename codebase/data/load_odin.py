...
def load_odin_as_ml_dataset(
    ...
    numerical_cols = [
        ...
        # ── Displacement-level distances & times (V) ───────────────────────────────
        ...
        "AfstS",          # V – Serie displacement distance NL (hectometres)
    ...
    ordinal_cols = [
        ...
        "RdSportA", "RdSportB",  # P – Reasons A/B sport venue not always reachable (Same as RdHalteA, RDHalteB)

        "BerWrk",  # P – Workplace: how often reachable? (1 Always, 2 Often, 3 Sometimes, 4 Seldom, 5 Never, 6 Unknown, 7 N/A (no need), 8 N/A < 15 y)
        "RdWrkA", "RdWrkB",  # P – Reasons A/B workplace not always reachable (Same as RdHalteA, RDHalteB)
        ...
        "RdOndA", "RdOndB",  # P – Reasons A/B education location not always reachable (Same as RdHalteA, RDHalteB)
        ...
        "RdSupA", "RdSupB",  # P – Reasons A/B supermarket not always reachable (Same as RdHalteA, RDHalteB)

        "BerZiek", # P – Hospital: how often reachable? (1 Always, 2 Often, 3 Sometimes, 4 Seldom, 5 Never, 6 Unknown, 7 N/A (no need), 8 N/A < 15 y)
        "RdZiekA", "RdZiekB",  # P – Reasons A/B hospital not always reachable (Same as RdHalteA, RDHalteB)

        "BerArts", # P – GP (doctor): how often reachable? (1 Always, 2 Often, 3 Sometimes, 4 Seldom, 5 Never, 6 Unknown, 7 N/A (no need), 8 N/A < 15 y)
        "RdArtsA", "RdArtsB",  # P – Reasons A/B GP not always reachable (Same as RdHalteA, RDHalteB)
        ...
        "RdStatA", "RdStatB",  # P – Reasons A/B station not always reachable (Same as RdHalteA, RDHalteB)
    ...
    categorical_cols = [
        ...
        # ── Displacement-level identifiers & flags (V-level) ───────────────────────
    ...
    dont_know = [
        ...
        # ── Displacement-level spatial codes ───────────────────────────────────────
